      ...
      <div className="text-bold">
        ...
        >
          ...
          >
            ...
            <label
              htmlFor="enter_otp"
              className="absolute text-lg text-gray-500  duration-500  -translate-y-8 scale-75 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-12 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-5 left-3"
            >
              Enter OTP
            </label>
